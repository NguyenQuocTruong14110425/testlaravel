...
use Box\Zendesk\Exceptions\AuthException;
use Box\Zendesk\Middleware\RetryHandler;
use Box\Zendesk\Resources\Chat;
use Box\Zendesk\Resources\Core\Activities;
use Box\Zendesk\Resources\Core\AppInstallations;
use Box\Zendesk\Resources\Core\Apps;
use Box\Zendesk\Resources\Core\Attachments;
use Box\Zendesk\Resources\Core\AuditLogs;
use Box\Zendesk\Resources\Core\Autocomplete;
use Box\Zendesk\Resources\Core\Automations;
use Box\Zendesk\Resources\Core\Bookmarks;
use Box\Zendesk\Resources\Core\Brands;
use Box\Zendesk\Resources\Core\CustomRoles;
use Box\Zendesk\Resources\Core\DynamicContent;
use Box\Zendesk\Resources\Core\GroupMemberships;
use Box\Zendesk\Resources\Core\Groups;
use Box\Zendesk\Resources\Core\Incremental;
use Box\Zendesk\Resources\Core\JobStatuses;
use Box\Zendesk\Resources\Core\Locales;
use Box\Zendesk\Resources\Core\Macros;
use Box\Zendesk\Resources\Core\OAuthClients;
use Box\Zendesk\Resources\Core\OAuthTokens;
use Box\Zendesk\Resources\Core\OrganizationFields;
use Box\Zendesk\Resources\Core\OrganizationMemberships;
use Box\Zendesk\Resources\Core\Organizations;
use Box\Zendesk\Resources\Core\OrganizationSubscriptions;
use Box\Zendesk\Resources\Core\PushNotificationDevices;
use Box\Zendesk\Resources\Core\Requests;
use Box\Zendesk\Resources\Core\SatisfactionRatings;
use Box\Zendesk\Resources\Core\Search;
use Box\Zendesk\Resources\Core\Sessions;
use Box\Zendesk\Resources\Core\SharingAgreements;
use Box\Zendesk\Resources\Core\SlaPolicies;
use Box\Zendesk\Resources\Core\SupportAddresses;
use Box\Zendesk\Resources\Core\SuspendedTickets;
use Box\Zendesk\Resources\Core\Tags;
use Box\Zendesk\Resources\Core\Targets;
use Box\Zendesk\Resources\Core\TicketFields;
use Box\Zendesk\Resources\Core\TicketImports;
use Box\Zendesk\Resources\Core\Tickets;
use Box\Zendesk\Resources\Core\Triggers;
use Box\Zendesk\Resources\Core\TwitterHandles;
use Box\Zendesk\Resources\Core\UserFields;
use Box\Zendesk\Resources\Core\Users;
use Box\Zendesk\Resources\Core\Views;
use Box\Zendesk\Resources\Embeddable;
use Box\Zendesk\Resources\HelpCenter;
use Box\Zendesk\Resources\Voice;
use Box\Zendesk\Traits\Utility\InstantiatorTrait;
use Box\Zendesk\Utilities\Auth;
...
class HttpClient
{
     ...
     * @throws \Box\Zendesk\Exceptions\AuthException
